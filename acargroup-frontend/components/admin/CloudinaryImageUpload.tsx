...
export default function CloudinaryImageUpload({
    ...
    const handleFileChange = async (e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (file.size > 5 * 1024 * 1024) {
            ...
            toast.error("Resim boyutu maksimum 5MB olabilir!");
            return;
        }
        ...
        try {
            ...
            if (response.ok) {
                ...
                const imageUrl = data.imageUrl || data.heroImageUrl || data.logoUrl || data.url;
                ...
                if (imageUrl) {
                    ...
                    toast.error("Resim URL'si alınamadı.");
                }
            } else {
    ...
    return (
        <div className="space-y-2">
            ...
            {preview && (
                <div className="relative w-40 h-40 border-2 border-slate-200 rounded-lg overflow-hidden">
                    <img
                        src={preview}
                        alt="Preview"
            ...
            <p className="text-xs text-slate-500">Maksimum 5MB, JPG/PNG/WEBP</p>
        </div>
    );
}
