...
export default function AdminDashboard() {
    ...
    const updateSetting = async (key: string, value: boolean | string) => {
        ...
        try {
            const token = getToken();
            const updatedInfo = { ...companyInfo, [key]: value };
                ...
                <div className="space-y-6">
                    <div>
                        <CloudinaryImageUpload
                            ...
                            onUploadSuccess={(url) => updateSetting("logoUrl", url)}
                        />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => updateSetting("logoTitle", e.target.value)}
                            onBlur={(e) => updateSetting("logoTitle", e.target.value)}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onBlur={(e) => updateSetting("logoText", e.target.value)}
                            className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-slate-900"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => updateSetting("tickerText", e.target.value)}
                            onBlur={(e) => updateSetting("tickerText", e.target.value)}
                            className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-slate-900"
                    ...
                    <SettingsToggle
                        ...
                        onToggle={(val) => updateSetting("showCurrencyRates", val)}
                    />
                </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-8 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <SettingsToggle
                        ...
                        onToggle={(val) => updateSetting("isWhatsappButtonActive", val)}
                    />
                    <SettingsToggle
                        ...
                        onToggle={(val) => updateSetting("isInternetApplicationButtonActive", val)}
                    />
                </div>
            </div>
