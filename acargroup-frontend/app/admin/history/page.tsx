    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setEditingItem(null);
                setFormData({ years: "", title: "", description: "", icon: "HiOutlineStar", imageUrl: "" });
                fetchItems();
            } else {
                    ...
                    <div key={item.id} className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex items-start justify-between">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                {item.imageUrl && (
                                    <img src={item.imageUrl} alt={item.title} className="mt-3 rounded-lg w-32 h-32 object-cover" />
                                )}
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-slate-500">İkon yerine veya ile birlikte fotoğraf ekleyebilirsiniz</p>
                            </div>
